...
gapminder_France %>% ggplot(aes(x=year,y=lifeExp))+geom_point() #ok to fit lm
```
...
lm_resid<-augment(my_lm) #broom::augment
...
gapminder_Zimbabwe %>% ggplot(aes(year, lifeExp)) + geom_point() #+ylim(c(0,70))
```
